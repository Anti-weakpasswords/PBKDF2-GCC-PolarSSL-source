...
// You SHOULD get your own copy of PolarSSL from the official site and extract it.
//  Then take polarssl-x.y.z/library/pkcs5.c, copy it to the directory with
//  pbkdf2_polarssl.c, rename it to pkcs5_without_pbes2_or_cipherInclude.c,
//  delete the line: #include "polarssl/cipher.h"
//  delete the entire function : pkcs5_pbes2
